...
The idea is, given I am starting from zero this blog, it will require context, for this I will include different "tracks" covering tensions between countries, recent history of conflicts of countries etc.
These tracks will later include links to specific real-time updated information.
...
In regards to AI, I will probably use existing models as information queriers (as some sort of smarter replacement of older encyclopedias) but the development of the actual posts will be written manually by myself like in older times (that is, I will not use AI to generate the text but as a capability for information gathering that will also be cross-checked to make sure about its veracity)
